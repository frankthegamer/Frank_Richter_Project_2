(async function(){
  ...
  async function startGame(){
    ...
    // Canvas already exists in HTML: <canvas id="renderCanvas">
    ...
    // Camera (FreeCamera for reliable WASD + mouse look)
    ...
    groundMat.diffuseColor = new BABYLON.Color3(0.1,0.6,0.1); // green
